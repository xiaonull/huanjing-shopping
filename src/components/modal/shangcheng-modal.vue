<template>
  <div class="shangcheng-modal modal" ref="shangchengModal" :class="{'hide': !showModal}">
    <div class="modal-header" ref="modalHeader">商城<div class="modal-btn-close" ref="btnClose" @click="close($event)"></div>
    </div>
    <div class="modal-content">该功能暂未开放，敬请期待！</div>
  </div>
</template>
<script>
export default {
  name: 'shangcheng-modal',
  props: ['showModal'],
  data () {
    return {
    }
