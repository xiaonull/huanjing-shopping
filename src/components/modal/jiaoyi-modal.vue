      ...
      <div class="modal-content">
        ...
        <div class="tabs-content">
          ...
          <div class="tabs-content-item record" v-show="outerTabSelect == 3">
            ...
            <div class="content-content">
              <!-- 购买记录 -->
              <div class="content-content-item" v-show="recordTabSelect == 1">
                <div class="content-record-list" v-for="item in goumaiR">
                  <div class="content-record-list-content">
                    <div class="record-list-content-row-1">
                      <div class="record-name-title">{{ item.buy_user ? item.buy_user.name :  '无买家信息' }}</div>
              ...
              <!-- 出售记录 -->
              <div class="content-content-item" v-show="recordTabSelect == 2">
              ...
              <!-- 委托记录 -->
              <div class="content-content-item" v-show="recordTabSelect == 3">
              ...
              <!-- 取消记录 -->
              <div class="content-content-item" v-show="recordTabSelect == 4">
